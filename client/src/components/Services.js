...
function Service(){
    return(
        ...
        <div>
        <div id="services" class="p-top-90 p-bot-90 light-gray-bg div_bot2">
                    <div class="container wow fadeIn" data-wow-delay="0.5s">
                       <div class="row">
                          <div class="col-md-5 center-block">
                             <div class="heading text-center">
                                <h2 class="light-font">Services</h2>
                       ...
                       <div class="row">
                          <div class="col-sm-4">
                             <div class="icon-box">
                                ...
                                <h3 class="title-sm text-theme-sm text-theme">
                                   Oranic Intelligence
                                 </h3>
                                <p>
                                   Effective thinking, effective actions, effective relationship and effective accomplishment
                                 </p>
                             </div>
                          </div>
                          <div class="col-sm-4">
                 ...
                 <div class="p-top-90 p-bot-90 parallax parallax_color_gradient"  data-stellar-background-ratio="0.1">
                    <div class="container">
